...
def get_motion_stats_for_date_range(
    ...
    dates = list(_iter_dates_inclusive(start_date, end_date))
    by_date = _compute_motion_stats_for_dates(dates, db_filename)
    daily_stats = [by_date[date] for date in dates]
